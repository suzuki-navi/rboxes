...
smart_cp markdown2html.py src/markdown2html.py && add_gitignore /src/markdown2html.py
smart_cp mdlib.js src/mdlib.js && add_gitignore /src/mdlib.js
smart_cp template.html src/template.html && add_gitignore /src/template.html
